...
### Compound Data Types
These types are constructed using a combination of [Basic Data Types](#basic-data-types).
...
| --- | --- | --- |
| Red | U8 | The red-value of the color. |
| Green | U8 | The green-value of the color. |
| Blue | U8 | The blue-value of the color. |
